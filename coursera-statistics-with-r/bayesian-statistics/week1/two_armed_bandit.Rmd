...
```{r E4}
data = data.frame(machine = c(1L, 1L, 1L, 1L, 2L, 2L, 2L, 1L, 2L, 1L, 2L, 2L), outcome = c("L", "L", "L", "W", "L", "L", "W", "W", "W", "W", "W", "W"))
