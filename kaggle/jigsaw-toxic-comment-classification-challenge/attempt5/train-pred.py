...
VOCAB_DATA = '../data/attempt5/vocab-5.txt'
TRAIN_DATA = '../data/attempt5/pre-train.csv'
TEST_DATA = '../data/attempt5/pre-test.csv'
PRED_DATA = '../data/attempt5/pred-5.csv'
...
def train(data, vocab):
    ...
    return SklearnClassifier(BernoulliNB()).train(feats)
