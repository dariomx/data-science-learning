...
VOCAB_DATA = '../data/attempt6/vocab-6.txt'
TRAIN_DATA = '../data/attempt6/pre-train.csv'
TEST_DATA = '../data/attempt6/pre-test.csv'
PRED_DATA = '../data/attempt6/pred-6.csv'
...
def train(data, vocab):
    ...
    return SklearnClassifier(SVC(probability=True)).train(feats)
